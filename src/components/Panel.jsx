...
export default function Panel() {
    return(
        <div className='hidden min-w-[25%] md:flex flex-col items-center justify-center h-screen border-r-4 border-black' style={{ backgroundColor: 'rgba(255, 255, 255, 0.7)' }}>
